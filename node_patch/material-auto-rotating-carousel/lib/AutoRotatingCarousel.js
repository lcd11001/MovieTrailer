...
var _RaisedButton = require('material-ui/Button');
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _Paper2.default,
            {
              ...
              style: _extends({}, style.carouselWrapper, this.props.carouselWrapperStyle) },
            _react2.default.createElement(
              _SwipableCarouselView2.default,
              {
                ...
                style: _extends({}, style.carousel, this.props.carouselStyle),
                containerStyle: _extends({}, style.carouselContainer, this.props.carouselContainerStyle),
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { style: landscape ? _extends({}, style.footerLandscape, this.props.footerStyle) : _extends({}, style.footer, this.props.footerStyle) },
              ...
              _react2.default.createElement(_materialUiDots2.default, {
                ...
                style: landscape ? _extends({}, style.dotsLandscape, this.props.dotsStyle) : _extends({}, style.dots, this.props.dotsStyle),
          ...
          !this.props.mobile && !this.props.hideArrows ? _react2.default.createElement(
            ...
            _react2.default.createElement(
              _Paper2.default,
              {
                style: _extends({}, style.arrowLeft, this.props.arrowLeftStyle),
                circle: true
              },
              _react2.default.createElement(
                _IconButton2.default,
                {
                  style: _extends({}, style.arrowIconButton, this.props.arrowIconButtonStyle),
                  iconStyle: _extends({}, style.arrowIcon, this.props.arrowIconStyle),
            ...
            _react2.default.createElement(
              _Paper2.default,
              {
                style: _extends({}, style.arrowRight, this.props.arrowRightStyle),
                circle: true
              },
              _react2.default.createElement(
                _IconButton2.default,
...
AutoRotatingCarousel.propTypes = {
  ...
  arrowIcon: _propTypes2.default.object,
  /** Override the inline-styles of the arrow icon button */
  arrowIconButtonStyle: _propTypes2.default.object,
  /** Override the inline-styles of the left arrow. */
  arrowLeftStyle: _propTypes2.default.object,
  /** Override the inline-styles of the right arrow. */
  arrowRightStyle: _propTypes2.default.object,
  /** If `false`, the auto play behavior is disabled. */
  autoplay: _propTypes2.default.bool,
  /** Override the inline-styles of the carousel container. */
  carouselContainer: _propTypes2.default.object,
  ...
  carouselWrapperStyle: _propTypes2.default.object,
  ...
  dotsStyle: _propTypes2.default.object,
